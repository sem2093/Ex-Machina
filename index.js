...
bluediv.classList.remove("mb-5","bg-body-tertiary", "rounded");
...
bluenav.classList.remove("mb-5","bg-body-tertiary", "rounded");
...
bluedivs.classList.remove("mb-5","bg-body-tertiary", "rounded");
...
bluenavs.classList.remove("mb-5","bg-body-tertiary", "rounded");
